...
export const PLATFORMS: PlatformDefinition[] = [
  ...
  { x: 220, y: 1670, width: 240, height: 30 },
  { x: 620, y: 1670, width: 190, height: 30 },
  { x: 430, y: 1570, width: 270, height: 30 },
  { x: 150, y: 1470, width: 170, height: 30 },
  { x: 700, y: 1470, width: 145, height: 30 },
  { x: 430, y: 1370, width: 190, height: 30 },
  { x: 210, y: 1270, width: 130, height: 30 },
  { x: 650, y: 1270, width: 130, height: 30 },

  { x: 970, y: 1670, width: 210, height: 30 },
  { x: 1450, y: 1670, width: 210, height: 30 },
  { x: 1220, y: 1570, width: 260, height: 30 },
  { x: 940, y: 1470, width: 155, height: 30 },
  { x: 1510, y: 1470, width: 145, height: 30 },
  { x: 1230, y: 1370, width: 240, height: 30 },
  { x: 1230, y: 1270, width: 125, height: 30 },

  { x: 1740, y: 1670, width: 180, height: 30 },
  { x: 2260, y: 1670, width: 180, height: 30 },
  { x: 1850, y: 1570, width: 230, height: 30 },
  { x: 2150, y: 1570, width: 230, height: 30 },
  { x: 2000, y: 1470, width: 500, height: 30 },
  { x: 1810, y: 1370, width: 145, height: 30 },
  { x: 2190, y: 1370, width: 145, height: 30 },
  { x: 2000, y: 1270, width: 210, height: 30 },
  { x: 2000, y: 1170, width: 100, height: 30 },

  { x: 2470, y: 1670, width: 190, height: 30 },
  { x: 3130, y: 1670, width: 160, height: 30 },
  { x: 2630, y: 1570, width: 210, height: 30 },
  { x: 2980, y: 1570, width: 190, height: 30 },
  { x: 2480, y: 1470, width: 125, height: 30 },
  { x: 3130, y: 1470, width: 145, height: 30 },
  { x: 2600, y: 1370, width: 145, height: 30 },
  { x: 3000, y: 1370, width: 145, height: 30 },
  { x: 2800, y: 1270, width: 240, height: 30 },

  { x: 3300, y: 1670, width: 130, height: 30 },
  { x: 3510, y: 1670, width: 130, height: 30 },
  { x: 3750, y: 1670, width: 130, height: 30 },
  { x: 3930, y: 1670, width: 115, height: 30 },
  { x: 3420, y: 1570, width: 145, height: 30 },
  { x: 3650, y: 1570, width: 190, height: 30 },
  { x: 3880, y: 1570, width: 145, height: 30 },
  { x: 3500, y: 1470, width: 115, height: 30 },
  { x: 3800, y: 1470, width: 160, height: 30 },
  { x: 3650, y: 1370, width: 240, height: 30 },
  { x: 3650, y: 1270, width: 100, height: 30 },

  { x: 4110, y: 1670, width: 145, height: 30 },
  { x: 4690, y: 1670, width: 130, height: 30 },
  { x: 4270, y: 1570, width: 145, height: 30 },
  { x: 4530, y: 1570, width: 145, height: 30 },
  { x: 4140, y: 1470, width: 130, height: 30 },
  { x: 4400, y: 1470, width: 145, height: 30 },
  { x: 4660, y: 1470, width: 130, height: 30 },
  { x: 4280, y: 1370, width: 145, height: 30 },
  { x: 4520, y: 1270, width: 145, height: 30 },
  { x: 4280, y: 1170, width: 145, height: 30 },
  { x: 4520, y: 1070, width: 145, height: 30 },
